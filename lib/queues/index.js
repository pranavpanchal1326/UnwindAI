...
export const orchestratorQueue = connection ? new Queue('orchestrator', {
  connection,
...
export const professionalTaskQueue = connection ? new Queue(
  'professional-tasks',
  {
    connection,
    defaultJobOptions: DEFAULT_JOB_OPTIONS
...
export const escalationQueue = connection ? new Queue('escalations', {
  connection,
  defaultJobOptions: {
    ...DEFAULT_JOB_OPTIONS,
...
export const summaryQueue = connection ? new Queue('summaries', {
  connection,
  defaultJobOptions: {
    ...DEFAULT_JOB_OPTIONS,
...
export const mlPredictionQueue = connection ? new Queue('ml-predictions', {
  connection,
  defaultJobOptions: {
    ...DEFAULT_JOB_OPTIONS,
    attempts: 2
